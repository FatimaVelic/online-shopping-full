...
Purpuse:        Page displays details of selected product. 
*/
...
while($rw=mysqli_fetch_array($qry))
{
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="product-details.php?pid=<?php echo htmlentities($rw['id']);?>"><img  src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($rw['id']);?>/<?php echo htmlentities($rw['productImage1']);?>" width="180" height="240" alt=""></a>
			</div><!-- /.image -->			
