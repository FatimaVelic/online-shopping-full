...
Purpuse:        Page displays requested search results. 
*/
...
<div class="side-menu animate-dropdown outer-bottom-xs">
    <div class="head"></i>Shop Categories</div>        
</div>
</div>
...
{?>							
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="product-details.php?pid=<?php echo htmlentities($row['id']);?>"><img  src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" alt="" width="150" height="180"></a>
			</div>	                      		   
		</div>
